...
// annotated overlay can render without double-rendering.
const NATIVE_SELECTOR = '.dss-subtitle-renderer-wrapper';
const TEXT_SELECTOR = '.dss-subtitle-renderer-cue';

export class DisneyPlusHook {

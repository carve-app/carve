/* @ts-self-types="./ja_tokenizer.d.ts" */
 ...
 */
export function init(dict_bytes) {
    const ptr0 = passArray8ToWasm0(dict_bytes, wasm.__wbindgen_malloc);
 ...
 * @returns {string}
 */
export function reading_of(text) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.reading_of(ptr0, len0);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
